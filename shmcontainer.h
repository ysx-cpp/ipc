...
public:
	...
	CString(const CString&) = default; //Ĭ�ϵ��û���Ŀ�������
...
public:
	...
	CVector(const CVector&) = default; //Ĭ�ϵ��û���Ŀ�������
...
public:
	...
	CList(const CList&) = default; //Ĭ�ϵ��û���Ŀ�������
	CList(CList&&) = default;
...
public:
	...
	CPair(const CPair&) = default; //Ĭ�ϵ��û���Ŀ�������
	CPair(CPair&&) = default;
...
public:
	...
	CMap(const CMap&) = default; //Ĭ�ϵ��û���Ŀ�������
	CMap(CMap&&) = default;
